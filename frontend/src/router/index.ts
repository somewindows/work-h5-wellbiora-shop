...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/checkout', name: 'checkout', component: () => import('@/views/CheckoutView.vue'), meta: { title: '结算' } },
  ...
  { path: '/order/:id', name: 'order', component: () => import('@/views/OrderDetailView.vue'), meta: { title: '订单详情' } },
  { path: '/mine', name: 'mine', component: () => import('@/views/MineView.vue'), meta: { title: '我的' } },
