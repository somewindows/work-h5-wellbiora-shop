...
const ORDERS = [
  ...
  },
  {
    ...
    items: [
      { id: 'p1', name: '脂质体谷胱甘肽饮', spec: '5ml × 30袋 / 盒', price: 329, qty: 1, themeLight: '#E3F0F3', img: 'assets/p1-main.jpg' },
...
/* 工具：订单合计（元，原型演示用；工程化后统一用分） */
function orderTotal(o) {
  return o.items.reduce((s, p) => s + p.price * p.qty, 0);
}
function orderCount(o) {
  return o.items.reduce((s, p) => s + p.qty, 0);
}
function findOrder(no) {
  return ORDERS.find(o => o.no === no) || ORDERS[0];
}
