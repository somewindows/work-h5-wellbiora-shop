...
- [~] 自建 H5 商城的 `plaformCode` 海关编码取值：已获公司海关注册号 **5101960X8F**（成都泽芃铭贸易，单一窗口备案截图 2026-08-26），编码格式与君梦文档示例一致（10 位海关注册编码），**疑似即 plaformCode 取值**，待君梦最终确认（顺带确认有赞编码文档矛盾：3301961SWG vs 3301961H10）
