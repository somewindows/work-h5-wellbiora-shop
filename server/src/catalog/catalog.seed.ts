...
const product = (index: number, blocks: ContentBlock[]): ProductDetail => ({
  ...PRODUCTS[index],
...
export const PRODUCT_DETAILS: Record<string, ProductDetail> = {
  WB10001: product(0, [
    ...
    { type: 'scenario', title: '它适合你吗？', items: ['关注日常抗氧化养护', '经常熬夜、作息不规律', '注重由内而外的状态管理'] },
    { type: 'image', src: '/assets/p1-tech.jpg' }, { type: 'image', src: '/assets/p1-ingredients.jpg' },
  ...
  WB10002: product(1, [
    ...
    { type: 'scenario', title: '它适合你吗？', items: ['日常蔬果摄入不足', '经常熬夜、感觉状态不佳', '关注肌肤与气色的日常养护'] },
    { type: 'badges', title: '配方特点', items: ['纯素', '无糖', '无麸质', '非转基因', '不含人工添加剂', '欧洲制造'] },
    { type: 'image', src: '/assets/p2-tech.jpg' }, { type: 'image', src: '/assets/p2-absorb.jpg' },
    { type: 'image', src: '/assets/p2-ingredients.jpg' }, { type: 'image', src: '/assets/p2-biotin.jpg' },
    { type: 'image', src: '/assets/p2-flavor2.jpg' }, { type: 'image', src: '/assets/p2-usage.jpg' },
    { type: 'nutrition', title: '营养成分表', meta: '每份食用量：5毫升（1袋）｜每盒份数：30', head: ['成分', '每份含量', 'NRV%'], rows: [
      ['维生素C（抗坏血酸钠）', '1000mg', '1000%'], ['生物素', '35mcg', '117%'],
      ['柑橘生物类黄酮', '10mg', '†'], ['大豆卵磷脂', '100mg', '†'],
  ...
  WB10003: product(2, [
    ...
    { type: 'scenario', title: '它适合你吗？', items: ['睡前难以放松下来', '作息不规律、倒时差', '希望醒来感觉更清爽'] },
    { type: 'badges', title: '配方特点', items: ['纯素', '无糖', '无麸质', '非转基因', '不含人工添加剂', '欧洲制造'] },
    { type: 'image', src: '/assets/p3-stages.jpg' }, { type: 'image', src: '/assets/p3-formula.jpg' }, { type: 'image', src: '/assets/p3-scene.jpg' },
    { type: 'nutrition', title: '营养成分表', meta: '每份食用量：1mL（6次喷压）｜每瓶份数：30', head: ['成分', '每份含量', 'NRV%'], rows: [
      ['GABA（γ-氨基丁酸）', '60mg', '†'], ['肌醇', '50mg', '†'], ['L-茶氨酸', '40mg', '†'], ['L-甘氨酸', '35mg', '†'],
  ...
  WB10004: product(3, [
    ...
    { type: 'stats', items: [
      ...
      { n: '30', unit: 'mg', l: '辅酶Q10（泛醇）', d: 'COQ10' }, { n: '30', unit: '日', l: '每日一袋，一月一盒', d: '30-DAY SUPPLY' },
    ] },
    { type: 'scenario', title: '它适合你吗？', items: ['日常日晒不足、久居室内', '关注骨骼的日常养护', '有运动健身习惯'] },
    { type: 'badges', title: '配方特点', items: ['纯素', '无糖', '无麸质', '非转基因', '不含人工添加剂', '欧洲制造'] },
    { type: 'image', src: '/assets/p4-tech.jpg' }, { type: 'image', src: '/assets/p4-absorb.jpg' }, { type: 'image', src: '/assets/p4-benefits.jpg' },
    { type: 'image', src: '/assets/p4-flavor.jpg' }, { type: 'image', src: '/assets/p4-usage.jpg' },
    { type: 'nutrition', title: '营养成分表', meta: '每份食用量：5mL（1袋）｜每盒份数：30', head: ['成分', '每份含量', 'NRV%'], rows: [
      ['维生素D（胆钙化醇，来源于藻类）', '100mcg（4000 IU）', '1000%'], ['维生素K2（MK-7）', '75mcg', '94%'],
      ['辅酶Q10（泛醇）', '30mg', '†'], ['大豆卵磷脂', '230mg', '†'],
...
export const HOME_BLOCKS: ContentBlock[] = [
  ...
  { type: 'brand_block', kick: 'Our Science', title: '普通补剂仅在体内路过，\nWellbiora 营养可被真正吸收。', desc: '每一剂营养成分都被磷脂双分子层包裹——这种结构与人体细胞膜相似——保护营养成分通过消化过程，增强其进入血液的吸收，让你获得全部益处。', image: '/assets/p4-tech.jpg' },
]
