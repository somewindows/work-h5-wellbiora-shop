      ...
      imports: [
        TypeOrmModule.forRootAsync({
          ...
          useFactory: (config: ConfigService) => ({
            ...
            entities: [UserEntity, SmsVerificationCodeEntity, SmsIpRateLimitEntity, CartItemEntity, AddressEntity, RealnameProfileEntity, OrderEntity, OrderItemEntity, OrderStatusEventEntity, RefundEntity, AdminAccountEntity, CatalogProductEntity, AuditLogEntity, ContentVersionEntity, AdminLoginRateLimitEntity],
            synchronize: false,
          }),
        }),
      ],
